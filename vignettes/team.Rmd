...
For `r if(exists("team_en")) {nrow(team_en)}` KWB team members the information is available in English.
...
For `r if(exists("team_de")) {nrow(team_de)}` KWB team members the information is available in German.
