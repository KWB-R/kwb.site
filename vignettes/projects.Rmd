...
plot_project_gant_chart(project_json ="projects.json")
...
```{r fig.height=15, fig.width=7}
plot_project_gant_chart(project_json ="projects.json", tag_selection = "topic")
```
...
```{r fig.height=15, fig.width=7}
plot_project_gant_chart(project_json ="projects.json",language_selection = "de")
